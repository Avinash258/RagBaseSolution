# Playwright Docs — docs network

Source: https://playwright.dev/docs/network

Network | PlaywrightSkip to main contentOn this page
# Network
...
`await page.route('**/title.html',asyncroute=>{
...
If you're interested in not solely using Service Workers for testing and network mocking, but in routing and listening for requests made by Service Workers themselves, please see this guide.
Introduction
Mock APIs
Network mocking
HTTP Authentication
