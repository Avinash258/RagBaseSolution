# Playwright Docs — docs writing-tests

Source: https://playwright.dev/docs/writing-tests

Writing tests | PlaywrightSkip to main contentOn this page
# Writing tests
...
awaitexpect(page.getByRole('heading',{name:'Installation'})).toBeVisible();
});
`
note
...
awaitexpect(page).toHaveURL('https://playwright.dev/');
});
});
`
