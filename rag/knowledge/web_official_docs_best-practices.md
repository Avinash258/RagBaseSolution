# Playwright Docs — docs best-practices

Source: https://playwright.dev/docs/best-practices

Best Practices | PlaywrightSkip to main contentOn this page
# Best Practices
...
`pnpmexec playwright codegen playwright.dev
`
...
`pnpmexec playwright test--debug
`
...
`pnpmexec playwright test example.spec.ts:9 --debug
`
...
`pnpmexec playwright test--trace on
`
...
`pnpmexec playwright test--shard=1/3
`
